...
- petween 基线：64 测试文件 / 1115 用例全绿（`84cebfe` = `11830e5`（Phase 18 保存文案对齐）+ 粒子特效扩容六枚举；`6ed667e` 起 `changePoseWithinActive` 默认 true——2026-09-18 用户拍板，桌面/DSH 两宿主共用）；petween-physics 基线：12 文件 / 194 用例（`02b582a`）。

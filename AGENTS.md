...
├── vendor/petween          ← git submodule → github.com/Traveritas/petween（锁定 382f148）
...
- petween 基线：63 测试文件 / 1105 用例全绿（`382f148` = V1.2 工作台 + P12 scrub/zoom + P13 多选/undo；`6ed667e` 起 `changePoseWithinActive` 默认 true——2026-09-18 用户拍板，桌面/DSH 两宿主共用）；petween-physics 基线：10 文件 / 166 用例。
